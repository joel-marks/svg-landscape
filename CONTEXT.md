...
- Help (opens modal) — see section 10.
...
## 10. Help
Single in-app modal (no separate route/page) — keeps this a true one-pager. Contains: control explanations (a condensed pass over section 5's descriptions, written for an end user rather than a developer — not a verbatim dump of this document), the seed/reproducibility caveat from section 8, and where to find the Tips toggle. Opened from the Help entry in the new Preferences folder (section 5).
